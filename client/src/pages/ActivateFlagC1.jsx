  ...
  .then(response => {
    ...
    .then(json => {
      if ('3pc' in json){
        ...
        // The user pass 
        alert('cookies are blocked. Please make sure to unblock cookies.')
      } 
    }).catch(err => {
      console.log(err);
      //return false
      ...
      />
        ...
        <div className=" pb-12 text-left max-w-4xl p-8 bg-white rounded shadow-lg ">
          ...
          <p className="mt-3 text-lg text-gray-600">
            ...
            <strong>2. </strong>Please go to: <strong> chrome://flags/#tpc-phase-out-facilitated-testing </strong> to activate it and choose <strong>Enabled Force Control1.</strong> <br />
            <img src={`${process.env.PUBLIC_URL}/assets/control-flag.png`} alt="test-enabled-flag" /> <br />
            <strong>3.</strong> Finally <strong>Relaunch</strong> Chrome as follow: <br />
