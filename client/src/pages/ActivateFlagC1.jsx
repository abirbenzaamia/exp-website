      ...
      />
        ...
        <div className=" pb-12 text-left max-w-4xl p-8 bg-white rounded shadow-lg ">
          ...
          <p className="mt-3 text-lg text-gray-600">
            ...
            <strong>1. </strong>Please copy and paste this link in the search bar: <br /><strong> chrome://flags/#test-third-party-cookie-phaseout</strong> <br /> and choose <strong>Disabled</strong> as the image shows.<br /> 
            <img src={`${process.env.PUBLIC_URL}/assets/test-disabled-flag.png`} alt="test-disabled-flag" /> <br />
            <strong>2. </strong> Please copy and paste this link in the search bar <br /> <strong> chrome://flags/#tpc-phase-out-facilitated-testing </strong> <br /> and choose <strong>Enabled Force Control1</strong> as the image shows. <br />
