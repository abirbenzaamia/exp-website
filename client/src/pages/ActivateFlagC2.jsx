      ...
      />
        ...
        <div className=" pb-12 text-left max-w-4xl p-8 bg-white rounded shadow-lg ">
          ...
          <p className="mt-3 text-lg text-gray-600">
            ...
            <strong>2. </strong>Please go to: <strong> chrome://flags/#tpc-phase-out-facilitated-testing </strong> to activate it and choose <strong>Enabled Force Control2.</strong> <br />
